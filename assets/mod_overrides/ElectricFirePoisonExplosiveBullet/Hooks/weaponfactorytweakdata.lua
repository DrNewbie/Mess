Hooks:PostHook(WeaponFactoryTweakData, "init", "bullet_class_alt_TweakData", function(self)
	self.parts.wpn_fps_electricfirepoisonexplosivebullet.custom_stats = {
		bullet_class = "InstantElectricAltBulletBase",
		bullet_class_alt = {
			fd = "wpn_fps_electricfirepoisonexplosivebullet",
			class = {
				"FlameBulletBase",
				"PoisonBulletBase",
