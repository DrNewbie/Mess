...
if UnlockableCharactersSys._hooks.re_fill_criminal then
	return
else
	UnlockableCharactersSys._hooks.re_fill_criminal = true
end
...
Hooks:PostHook(GroupAIStateBase, "fill_criminal_team_with_AI", UnlockableCharactersSys.__Name("re:re_fill_criminal"), function(self, is_drop_in, ...)
