local old_SkillTreeManager_verify_loaded_data = SkillTreeManager._verify_loaded_data
...
function SkillTreeManager:_verify_loaded_data(points_aquired_during_load, ...)
	...
	old_SkillTreeManager_verify_loaded_data(self, points_aquired_during_load, ...)
end
