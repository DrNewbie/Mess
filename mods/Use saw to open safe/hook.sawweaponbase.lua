Hooks:PostHook(SawHit, "on_collision", "SawHitSomeThings", function(self, col_ray, weapon_unit, user_unit, damage)
	local hit_unit = col_ray and col_ray.unit or nil
	if hit_unit and hit_unit:damage() and type(damage) == "number" and hit_unit:base() and hit_unit:base().tweak_data then
