...
local ThisBannerPath = ThisModPath.."/".."88476E74AAAAF401.dds"	--Artist: https://www.bilibili.com/video/BV1vYWszgESv/
...
Hooks:PostHook(HUDManager, "_player_hud_layout", __Name(1), function(self)
	pcall(function()
		...
		self[dt3] = 1 + math.random() * ( 1 + math.random() )
	end)
end)
