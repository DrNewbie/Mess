...
MutatorBirthday.texture = {
    path = "guis/textures/mutation_10th_birthday",
    custom = true
}
...
if not MutatorHelper then
	return
end

if not _G[Idstring("MutatorBirthday")]  then
	_G[Idstring("MutatorBirthday")] = true
	MutatorHelper:AddMutator(MutatorBirthday, ModPath)
end