...
function GiveMask:__GiveMaskToThis(them)
	...
	DelayedCalls:Add('F_'..Idstring('DelayedCalls:GiveMask:Everyone is 46th:'..tostring(them._unit:key())):key(), math.random()*20 + math.random(), function()
...
if CopMovement then
	Hooks:PostHook(CopMovement, "set_character_anim_variables", "F_"..Idstring("CopMovement:set_character_anim_variables:Everyone is 46th"):key(), function(self)
		GiveMask:__GiveMaskToThis(self)
	end)
end

if HuskCopMovement then
	Hooks:PostHook(HuskCopMovement, "set_character_anim_variables", "F_"..Idstring("HuskCopMovement:set_character_anim_variables:Everyone is 46th"):key(), function(self)
		GiveMask:__GiveMaskToThis(self)
	end)
end

if PlayerMovement then
	Hooks:PostHook(PlayerMovement, "set_character_anim_variables", "F_"..Idstring("PlayerMovement:set_character_anim_variables:Everyone is 46th"):key(), function(self)
		GiveMask:__GiveMaskToThis(self)
	end)
end

if HuskPlayerMovement then
	Hooks:PostHook(HuskPlayerMovement, "set_character_anim_variables", "F_"..Idstring("HuskPlayerMovement:set_character_anim_variables:Everyone is 46th"):key(), function(self)
		GiveMask:__GiveMaskToThis(self)
	end)
end

if TeamAIMovement then
	Hooks:PostHook(TeamAIMovement, "set_character_anim_variables", "F_"..Idstring("TeamAIMovement:set_character_anim_variables:Everyone is 46th"):key(), function(self)
		GiveMask:__GiveMaskToThis(self)
	end)
end

if HuskTeamAIMovement then
	Hooks:PostHook(HuskTeamAIMovement, "set_character_anim_variables", "F_"..Idstring("HuskTeamAIMovement:set_character_anim_variables:Everyone is 46th"):key(), function(self)
		GiveMask:__GiveMaskToThis(self)
	end)
end