...
function GiveMask:__GiveMaskToThis(them)
	...
	local __mask_unit, __try = "units/pd2_dlc_ja21/masks/msk_ja21_biden/msk_ja21_biden", 30
	if CopDamage.is_civilian(them._unit:base()._tweak_table) then
		__mask_unit = "units/pd2_dlc_win/masks/msk_win_donald/msk_win_donald"
	end
	...
	DelayedCalls:Add('F_'..Idstring('DelayedCalls:GiveMask:45th civilians, 46th cops:'..tostring(them._unit:key())):key(), math.random()*20 + math.random(), function()
...
if CopMovement then
	Hooks:PostHook(CopMovement, "set_character_anim_variables", "F_"..Idstring("CopMovement:set_character_anim_variables:45th civilians, 46th cops"):key(), function(self)
		GiveMask:__GiveMaskToThis(self)
	end)
end

if HuskCopMovement then
	Hooks:PostHook(HuskCopMovement, "set_character_anim_variables", "F_"..Idstring("HuskCopMovement:set_character_anim_variables:45th civilians, 46th cops"):key(), function(self)
		GiveMask:__GiveMaskToThis(self)
	end)
end

if PlayerMovement then
	Hooks:PostHook(PlayerMovement, "set_character_anim_variables", "F_"..Idstring("PlayerMovement:set_character_anim_variables:45th civilians, 46th cops"):key(), function(self)
		GiveMask:__GiveMaskToThis(self)
	end)
end

if HuskPlayerMovement then
	Hooks:PostHook(HuskPlayerMovement, "set_character_anim_variables", "F_"..Idstring("HuskPlayerMovement:set_character_anim_variables:45th civilians, 46th cops"):key(), function(self)
		GiveMask:__GiveMaskToThis(self)
	end)
end

if TeamAIMovement then
	Hooks:PostHook(TeamAIMovement, "set_character_anim_variables", "F_"..Idstring("TeamAIMovement:set_character_anim_variables:45th civilians, 46th cops"):key(), function(self)
		GiveMask:__GiveMaskToThis(self)
	end)
end

if HuskTeamAIMovement then
	Hooks:PostHook(HuskTeamAIMovement, "set_character_anim_variables", "F_"..Idstring("HuskTeamAIMovement:set_character_anim_variables:45th civilians, 46th cops"):key(), function(self)
		GiveMask:__GiveMaskToThis(self)
	end)
end