		...
		for _, script in pairs(managers.mission:scripts()) do
			for _id, element in pairs(script:elements()) do
				if element and element._values and element._values.dialogue and _id == v2 then
					...
					if dialog_ids[1][_dialogue_id] then
						_possible_ids._cids = 1
					elseif dialog_ids[2][_dialogue_id] then
						_possible_ids._cids = 2
					elseif dialog_ids[3][_dialogue_id] then
						_possible_ids._cids = 3
					else
						_possible_ids._cids = nil
					end
					break
