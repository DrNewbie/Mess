...
Hooks:PostHook(PlayerInventoryGui, "init", "CriticalPerkPlyInvInit", function(self)
	self:_update_specialization_box()
end)

Hooks:PostHook(PlayerInventoryGui, "_update_specialization_box", "CriticalPerkPlyInvUpdate", function(self)
		...
		if specialization_data then
			...
			if tier_data.custom and tier_data.texture then
				self:update_box(box, {
					...
					image_rect = {
						tier_data.icon_xy[1] or 0,
						tier_data.icon_xy[2] or 0,
						64,
						64
					}
				}, true)
